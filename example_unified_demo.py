...
def demo_unified_system():
    ...
    expr = UnifiedCucumberExpression('I drive a {car:phrase}', registry)
    ...
    expr2 = UnifiedCucumberExpression('I love {my_fruit:semantic}', registry)
    ...
    expr3 = UnifiedCucumberExpression('I need {furniture:dynamic}', registry)
    ...
    expr4 = UnifiedCucumberExpression('I {action:semantic} {count} {items:phrase}', registry)
    ...
    print("   Using old SemanticCucumberExpression:")
