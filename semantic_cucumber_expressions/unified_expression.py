# semantic_cucumber_expressions/unified_expression.py
...
class UnifiedCucumberExpression(CucumberExpression):
    """
    A unified cucumber expression that supports multiple parameter types
    ...
    def __init__(self, expression: str, parameter_type_registry):
        """
        Initialize a unified cucumber expression.
    ...
    def __repr__(self):
        return f"UnifiedCucumberExpression('{self.original_expression}')"