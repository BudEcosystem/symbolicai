# semantic_cucumber_expressions/semantic_expression.py
...
class SemanticCucumberExpression(CucumberExpression):
    """Enhanced Cucumber Expression with semantic matching capabilities"""
