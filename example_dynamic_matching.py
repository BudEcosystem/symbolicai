...
def demo_dynamic_matching():
    ...
    expr1 = SemanticCucumberExpression("I love {cars}", registry)
    ...
    expr2 = SemanticCucumberExpression("The {animal} ate the {food}", registry)
    ...
    expr3 = SemanticCucumberExpression("I ate {fruit} in my {vehicle}", registry)
    ...
    expr4a = SemanticCucumberExpression("I see a {bird}", registry)
    ...
    expr4b = SemanticCucumberExpression("I see a {bird}", registry)
    try:
    ...
    try:
        expr5 = SemanticCucumberExpression("I drive a {automobile}", registry)
    ...
    expr6 = SemanticCucumberExpression("I need a new {product}", registry)
