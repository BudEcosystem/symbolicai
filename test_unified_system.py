...
import unittest
from semantic_cucumber_expressions.unified_expression import UnifiedCucumberExpression
from semantic_cucumber_expressions.unified_registry import UnifiedParameterTypeRegistry
from semantic_cucumber_expressions.unified_parameter_type import UnifiedParameterType, ParameterTypeHint
...
class TestUnifiedSystem(unittest.TestCase):
    ...
    def test_standard_parameter_types(self):
        ...
        expr = UnifiedCucumberExpression("I have {count} items", self.registry)
        
        # Should work like regular cucumber expressions
    ...
    def test_semantic_parameter_types(self):
        ...
        # Test with type hint
        expr = UnifiedCucumberExpression("I drive a {vehicle:semantic}", self.registry)
        ...
        expr2 = UnifiedCucumberExpression("I drive a {vehicle}", self.registry)
    ...
    def test_phrase_parameter_types(self):
        ...
        expr = UnifiedCucumberExpression("I bought a {car_model:phrase}", self.registry)
    ...
    def test_dynamic_parameter_types(self):
        ...
        expr = UnifiedCucumberExpression("I love {cars:dynamic}", self.registry)
        ...
        expr2 = UnifiedCucumberExpression("I need {furniture}", self.registry)
    ...
    def test_regex_parameter_types(self):
        ...
        expr = UnifiedCucumberExpression("Send email to {email:regex}", self.registry)
    ...
    def test_quoted_parameter_types(self):
        ...
        expr = UnifiedCucumberExpression("Say {message:quoted}", self.registry)
    ...
    def test_phrase_boundary_detection(self):
        ...
        expr = UnifiedCucumberExpression("I bought {product:phrase}", self.registry)
    ...
    def test_phrase_length_limits(self):
        ...
        expr = UnifiedCucumberExpression("I like {short_phrase:phrase}", self.registry)
    ...
    def test_semantic_similarity_thresholds(self):
        ...
        expr = UnifiedCucumberExpression("I have a {strict_animal:semantic}", self.registry)
        ...
        expr2 = UnifiedCucumberExpression("I have a {loose_animal:semantic}", self.registry)
    ...
    def test_backward_compatibility(self):
        ...
        old_expr = SemanticCucumberExpression("I love {fruit}", old_registry)
        ...
        new_expr = UnifiedCucumberExpression("I love {fruit}", old_registry)
    ...
    def test_error_handling(self):
        ...
        expr = UnifiedCucumberExpression("I have {count:invalid}", self.registry)
        ...
        expr2 = UnifiedCucumberExpression("I eat {strict_fruit:semantic}", self.registry)
