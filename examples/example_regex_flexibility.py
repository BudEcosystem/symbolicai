#!/usr/bin/env python3
"""
Example showing how to handle flexible patterns in semantic bud expressions
"""
...
def demo_flexible_patterns():
    ...
    expr1 = SemanticBudExpression("I {emotion} {phrase}", registry)
    ...
    expr2 = SemanticBudExpression("I drive a {car_phrase}", registry)
    ...
    expr3 = SemanticBudExpression("I want a {luxury_car}", registry)
    ...
    expr4 = SemanticBudExpression("I am {emotion} {preposition} the {cars}", registry)
