...
def example_basic_usage():
    ...
    # Create expressions
    expr1 = SemanticBudExpression("I like {fruit}", registry)
    expr2 = SemanticBudExpression("{greeting}, how are you?", registry)
    expr3 = SemanticBudExpression("solve {math}", registry)
    exp4 = SemanticBudExpression("I am {emotion} about the {cars}", registry)
