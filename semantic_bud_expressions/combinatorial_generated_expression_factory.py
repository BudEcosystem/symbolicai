...
class budCombinatorialGeneratedExpressionFactory:
    ...
    def generate_expressions(self) -> List[budGeneratedExpression]:
    ...
    def generate_permutations(
        self,
        generated_expressions: List[budGeneratedExpression],
        depth: int,
        ...
        if depth == len(self.parameter_type_combinations):
            generated_expressions.append(
                budGeneratedExpression(self.expression_template, current_parameter_types)
            )
            return
