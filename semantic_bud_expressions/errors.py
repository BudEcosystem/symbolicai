...
def generate_message(
    ...
    return "\n".join(
        [
            f"This bud Expression has a problem at column {index + 1}:",
            "",
            expression,
            pointer,
            problem + ".",
...
class budExpressionError(Exception):
    def __init__(self, message: str):
        super().__init__(message)


class AlternativeMayNotExclusivelyContainOptionals(budExpressionError):
...
class AlternativeMayNotBeEmpty(budExpressionError):
    def __init__(self, node, expression: str):
        super().__init__(
            generate_message(
                index=node.start,
...
class CantEscape(budExpressionError):
...
class OptionalMayNotBeEmpty(budExpressionError):
    def __init__(self, node, expression: str):
        super().__init__(
            generate_message(
                index=node.start,
...
class ParameterIsNotAllowedInOptional(budExpressionError):
    def __init__(self, node, expression: str):
        super().__init__(
            generate_message(
                index=node.start,
...
class OptionalIsNotAllowedInOptional(budExpressionError):
    def __init__(self, node, expression: str):
        super().__init__(
            generate_message(
                index=node.start,
...
class MissingEndToken(budExpressionError):
...
class AlternationNotAllowedInOptional(budExpressionError):
...
class InvalidParameterTypeName(budExpressionError):
...
class InvalidParameterTypeNameInNode(budExpressionError):
...
class UndefinedParameterTypeError(budExpressionError):
...
class AmbiguousParameterTypeError(budExpressionError):
    def __init__(
        self,
...
1) Use a Bud Expression instead of a Regular Expression. Try one of these:
...
class TheEndOfLineCannotBeEscaped(budExpressionError):
