...
class TestDynamicSemanticMatching(unittest.TestCase):
    ...
    def test_predefined_category_takes_precedence(self):
        ...
        expr = SemanticCucumberExpression("I love {fruit}", self.registry)
    ...
    def test_dynamic_matching_for_undefined_category(self):
        ...
        expr = SemanticCucumberExpression("I love {cars}", self.registry)
    ...
    def test_dynamic_matching_semantic_similarity(self):
        ...
        expr = SemanticCucumberExpression("I drive a {automobile}", self.registry)
    ...
    def test_dynamic_matching_threshold(self):
        ...
        expr1 = SemanticCucumberExpression("I see a {thing}", self.registry)
        ...
        expr2 = SemanticCucumberExpression("I see a {vehicle}", self.registry)
    ...
    def test_multiple_dynamic_parameters(self):
        ...
        expr = SemanticCucumberExpression(
