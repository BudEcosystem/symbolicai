...
def demo_unified_final():
    ...
    expr1 = UnifiedCucumberExpression('I have {count} {pets:dynamic}', registry)
    ...
    expr2 = UnifiedCucumberExpression('Contact {email:regex}', registry)
    ...
    print("\n3. Math Expression:")
    expr3 = UnifiedCucumberExpression('Calculate {math}', registry)
    ...
    expr4 = UnifiedCucumberExpression('Say {msg:quoted}', registry)
